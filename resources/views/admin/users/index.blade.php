    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center">
                ...
                <!-- Text -->
                <div>
                    <p class="text-sm text-gray-500">{{ __('Total Visitors') }}</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $visitorCount }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="flex-grow">
                        ...
                        <p class="text-xs text-gray-400 mt-1">{{ __('Last Visit') }}: {{ $user->last_visit ? $user->last_visit->diffForHumans() : 'Never' }}</p>
                    </div>
                </div>
            </div>
        @endforeach
