    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <!--<div>
                 <a class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex" href="/">Home</a>
               </div>-->
       ...
       <div class="-mr-2 flex items-center sm:hidden">
           ...
           p-2 rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-500
            dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none
