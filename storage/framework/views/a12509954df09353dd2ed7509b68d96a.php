  ...
  <div class="container mx-auto px-4">
    <div class="flex flex-col sm:flex-row justify-between items-center">
      ...
      <nav class="hidden sm:flex sm:space-x-6 mt-4 sm:mt-0 w-full sm:w-auto" id="mobile-menu">
        <a href="<?php echo e(route('home')); ?>" class="text-white hover:text-blue-300 transition duration-300 ease-in-out font-medium">
          Home
        </a>
...
</script><?php /**PATH /var/www/laraub/resources/views/layouts/nav2.blade.php ENDPATH**/ ?>