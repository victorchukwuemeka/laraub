...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="flex-grow">
                        ...
                        <p class="text-xs text-gray-400 mt-1"><?php echo e(__('last Visit')); ?> : <?php echo e($user->last_visit); ?></p>
                        <p>Last Visit: <?php echo e(auth()->user()->last_visit ? auth()->user()->last_visit->diffForHumans() : 'Never'); ?></p>
    ...
    <div>
        <h2>VIsitors Count: <?php echo e($visitorCount); ?></h2>
    </div>
</div>
