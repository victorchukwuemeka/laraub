    ...
    <div class="container mx-auto mt-8 p-4 bg-white rounded-lg shadow-lg">
        ...
        <form action="<?php echo e(route('user.update', ['userId' => $user->id])); ?>" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="company" id="company" value="<?php echo e(optional($user->profile)->get_company() ?? ''); ?>" class="w-full border rounded px-3 py-2 mt-1">
            </div>
            ...
            <div class="mb-4">
                ...
                value="<?php echo e(optional($user->profile)->get_company_website() ?? ''); ?>"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="education" id="education" value="<?php echo e(optional($user->profile)->get_education() ?? ''); ?>" class="w-full border rounded px-3 py-2 mt-1">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="location" id="location"
                 value="<?php echo e(optional($user->profile)->get_location() ?? ''); ?>" class="w-full border rounded px-3 py-2 mt-1">
            ...
            <div class="space-y-4 mt-8">
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" id="job_title" name="job_title"
                     value="<?php echo e(old('job_title', optional($user->profile)->job_title)); ?>"
                     class="block mt-1 w-full border rounded">
                </div>
