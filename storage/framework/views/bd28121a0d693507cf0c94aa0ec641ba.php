  ...
  <div class="flex  justify-center items-center  pt-2 pr-4 py-0">
    ...
    <div class="py-0">
      ...
      <div class="flex items-center space-x-4">
       ...
       <a href="<?php echo e($project->website); ?>" class="px-4 py-2 text-white font-medium rounded-full bg-blue-500 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700">
         Website
       </a>
     </div>
    </div>
